...
namespace MonsterHunterCompanion
{
    public class Longsword : Blademaster
    {
        ...
        public Longsword(string Name, string Description, string Rarity, int Attack, int[] Sharpness) //add array of items
        {
            _name = Name;
        ...
        public Longsword(string Name, string Desc, string Rarity, int Attack, int SpAtk, int Aff, int Def, int slots, int[] Sharpness)
        {
            _name = Name;
